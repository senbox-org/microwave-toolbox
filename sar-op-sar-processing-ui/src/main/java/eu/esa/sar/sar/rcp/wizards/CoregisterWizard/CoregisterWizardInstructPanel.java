 ...
 */
package eu.esa.sar.sar.rcp.wizards.CoregisterWizard;
...
public class CoregisterWizardInstructPanel extends AbstractInstructPanel {
    ...
    public CoregisterWizardInstructPanel() {
        ...
        imgPosY = 240;
        try {
            image = ImageIO.read(ResourceUtils.getResourceAsStream("eu/esa/sar/sar/images/coreg.png", CoregisterWizardInstructPanel.class));
        } catch (IOException e) {
            image = null;
        }
    }
