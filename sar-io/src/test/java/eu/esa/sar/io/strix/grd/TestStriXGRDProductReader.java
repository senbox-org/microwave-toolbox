...
public class TestStriXGRDProductReader extends ReaderTest {
    ...
    final static File inputSMGRDMeta = new File(SARTests.inputPathProperty + "/SAR/Synspective/GRD/STRIX-A_SM_GRD_GeoTIFF_202111_044_2021-11-11T133724Z/PAR-20211111133724_SMGRD.xml");
    final static File inputSMGRDFolder = new File(SARTests.inputPathProperty + "/SAR/Synspective/GRD/STRIX-A_SM_GRD_GeoTIFF_202111_044_2021-11-11T133724Z");

    final static File inputSLGRDMeta = new File(SARTests.inputPathProperty + "/SAR/Synspective/GRD/STRIX-A_SL_GRD_GeoTIFF_202202-00075_2022-02-15T143911Z/PAR-20220215143910_SLGRD.xml");
    final static File inputSLGRDFolder = new File(SARTests.inputPathProperty + "/SAR/Synspective/GRD/STRIX-A_SL_GRD_GeoTIFF_202202-00075_2022-02-15T143911Z");
