...
public class TestSpacetyProductReader extends ReaderTest {
    ...
    final static File slc_sp1 = new File(SARTests.inputPathProperty +
    ...
    final static File slc_sm1 = new File(SARTests.inputPathProperty +
    ...
    final static File slc_sm2 = new File(SARTests.inputPathProperty +
    ...
    final static File slc_ns1 = new File(SARTests.inputPathProperty +
