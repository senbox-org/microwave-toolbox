 ...
 * The Gamma writer
 */
public class GammaProductWriterPlugIn implements ProductWriterPlugIn {
     ...
     */
    public GammaProductWriterPlugIn() {
    }
    ...
    public String[] getFormatNames() {
        return GammaProductReaderPlugIn.FORMATS;
    }
    ...
    public ProductWriter createWriterInstance() {
        return new GammaProductWriter(this);
    }
