...
public class NisarSMEProductReader extends NisarSubReader {
    ...
    @Override
    protected void addAbstractedMetadataHeader(MetadataElement root) throws Exception {
...
//                    );
            ...
            AbstractMetadata.setAttribute(absRoot, AbstractMetadata.PRODUCT_TYPE, getProductType(groupID));
