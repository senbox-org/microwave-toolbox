...
/**
 * Several constants used for reading SAOCOM products.
 */
class SaocomConstants {

    final static String[] METADATA_PREFIX = {"S1A", "S1B"};
    final static String METADATA_EXT = ".xemt";
    private final static String[] FORMAT_NAMES = new String[]{"SAOCOM"};
    private final static String[] FORMAT_FILE_EXTENSIONS = new String[]{METADATA_EXT};
    private final static String PLUGIN_DESCRIPTION = "SAOCOM Products";      /*I18N*/
