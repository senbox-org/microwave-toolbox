...
/**
 * The ReaderPlugIn for UAVSAR.
 */
public class UAVSARReaderPlugIn implements ProductReaderPlugIn {
    ...
    public static class FileFilter extends SnapFileFilter {
        ...
        public boolean accept(final File file) {
            if (super.accept(file)) {
                if (file.isDirectory() || UAVSARReader.findAnnotationFile(file) != null) {
                    return true;
                }
            }
            return false;
