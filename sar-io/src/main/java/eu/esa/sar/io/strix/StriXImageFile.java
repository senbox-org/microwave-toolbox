...
public class StriXImageFile extends CEOSImageFile {

    private final static String mission = "StriX";
    ...
    public StriXImageFile(final ImageInputStream imageStream, int prodLevel, String fileName)
            throws IOException {
    ...
    protected BinaryRecord createNewImageRecord(int line) throws IOException {
        ...
        if ((productLevel == StriXConstants.LEVEL1_5) || isIPF()) //IPF 1.1 SLC has PDR header structure
