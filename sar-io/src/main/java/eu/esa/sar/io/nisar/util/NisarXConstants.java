...
public class NisarXConstants {
    ...
    public static final String ANTENNA_POINTING = "lookDirection";
    public static final String BEAMS_DEFAULT_VALUE = "";
    public static final String PROCESSING_SYSTEM_IDENTIFIER = "processingCenter";
    public static final String CYCLE = "orbit_repeat_cycle";
    public static final String REL_ORBIT = "orbit_relative_number";
    public static final String ABS_ORBIT = "absoluteOrbitNumber";
    ...
    public static final String ACQUISITION_START_UTC = "zeroDopplerStartTime";
    public static final String ACQUISITION_END_UTC = "zeroDopplerEndTime";
    ...
    public static final String I_Q = "i_q";
    public static final String S_I = "s_i";
    public static final String S_Q = "s_q";
    public static final String S_AMPLITUDE = "s_amplitude";
    public static final String NISAR_PROCESSOR_NAME_PREFIX = "NISAR_P_";
    public static final String PROC_TIME_UTC = "processingDateTime";
    ...
    public static String[] getNisarFormatNames() {
        return NISAR_FORMAT_NAMES.split(",");
    }

    public static String[] getNisarFormatFileExtensions() {
        return NISAR_FORMAT_FILE_EXTENSIONS.split(",");
    }
}
