...
/**
 * The ReaderPlugIn for RAT products.
 */
public class SNAPHUProductReaderPlugIn implements ProductReaderPlugIn {

    private final static String[] FORMATS = new String[] {"SNAPHU"};
    private final static String EXT = ".snaphu.hdr";
