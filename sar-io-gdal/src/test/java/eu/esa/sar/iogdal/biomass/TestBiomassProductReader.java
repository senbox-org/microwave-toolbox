...
public class TestBiomassProductReader extends ReaderTest {
    ...
    public void testOpeningFile_L1A_SCS() throws Exception {
        try(Product prod = testReader(input_L1A_SCS.toPath())) {
            ...
            validator.validateProduct();
            validator.validateMetadata();
            validator.validateBands(new String[]{"i_S1_HH", "q_S1_HH", "Intensity_S1_HH", "i_S1_HV", "q_S1_HV", "Intensity_S1_HV", "i_S1_VH", "q_S1_VH", "Intensity_S1_VH", "i_S1_VV", "q_S1_VV", "Intensity_S1_VV"});
        }
    }
    ...
    public void testOpeningFile_L1C_SCS() throws Exception {
        try(Product prod = testReader(input_L1C_IntPhase_SCS.toPath())) {
            ...
            validator.validateProduct();
            validator.validateMetadata();
            validator.validateBands(new String[]{"i_S2_HH", "q_S2_HH", "Intensity_S2_HH", "i_S2_VV", "q_S2_VV", "Intensity_S2_VV", "i_S2_XX", "q_S2_XX", "Intensity_S2_XX"});
        }
    }
}
