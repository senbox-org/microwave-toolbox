...
public class TestBiomassProductReader extends ReaderTest {
    ...
    public final static File input_SCS = new File(pathPrefix+"BIOMASS/L1A_and_L1B/BIO_S1_SCS__1S_20170101T060309_20170101T060330_I_G03_M03_C03_T010_F001_01_D0NNPU/bio_s1_scs__1s_20170101t060309_20170101t060330_i_g03_m03_c03_t010_f001_01_d0nnpu.xml");
    ...
    public void setUp() {
        ...
        assumeTrue(input_SCS + " not found", input_SCS.exists());
    }
    ...
    @Test
    public void testOpeningFileSCS() throws Exception {
        try(Product prod = testReader(input_SCS.toPath())) {
