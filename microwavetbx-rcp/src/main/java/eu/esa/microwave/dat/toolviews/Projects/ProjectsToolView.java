...
@TopComponent.Description(
        ...
        iconBase = "eu/esa/microwave/dat/icons/project-view.png",
...
@ActionID(category = "Window", id = "eu.esa.microwave.dat.toolviews.Projects.ProjectsToolView")
@ActionReferences({
...
public class ProjectsToolView extends TopComponent implements Observer {
    ...
    private ProjectTree createTree() {
        ...
        renderer.setLeafIcon(UIUtils.loadImageIcon("/eu/esa/microwave/resources/images/icons/RsBandAsSwath16.gif"));
        renderer.setClosedIcon(UIUtils.loadImageIcon("/eu/esa/microwave/resources/images/icons/RsGroupClosed16.gif"));
        renderer.setOpenIcon(UIUtils.loadImageIcon("/eu/esa/microwave/resources/images/icons/RsGroupOpen16.gif"));
        return projectTree;
    }
