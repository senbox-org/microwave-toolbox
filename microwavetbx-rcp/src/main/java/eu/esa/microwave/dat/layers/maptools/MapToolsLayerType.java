...
@LayerTypeMetadata(name = "MapToolsLayerType",
        aliasNames = {"eu.esa.microwave.dat.layers.maptools.MapToolsLayerType"})
public class MapToolsLayerType extends LayerType {

    private static final String TYPE_NAME = "MapToolsLayerType";
    private static final String[] ALIASES = {"eu.esa.microwave.dat.layers.maptools.MapToolsLayerType"};
