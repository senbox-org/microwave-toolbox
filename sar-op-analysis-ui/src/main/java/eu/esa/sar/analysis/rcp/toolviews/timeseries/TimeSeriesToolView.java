 ...
 */
package eu.esa.sar.analysis.rcp.toolviews.timeseries;

import com.bc.ceres.glayer.support.ImageLayer;
import eu.esa.sar.analysis.rcp.toolviews.timeseries.actions.GraphExportImageAction;
import eu.esa.sar.analysis.rcp.toolviews.timeseries.actions.TimeSeriesExportAction;
import eu.esa.sar.analysis.rcp.toolviews.timeseries.actions.TimeSeriesFilterAction;
import eu.esa.sar.analysis.rcp.toolviews.timeseries.actions.TimeSeriesSettingsAction;
...
@TopComponent.Description(
        ...
        iconBase = "eu/esa/sar/analysis/icons/timeseries.png",
...
@ActionID(category = "Window", id = "eu.esa.sar.analysis.rcp.toolviews.timeseries.TimeSeriesToolView")
@ActionReferences({
